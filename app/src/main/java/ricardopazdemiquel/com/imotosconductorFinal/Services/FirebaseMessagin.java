...
import ricardopazdemiquel.com.imotosconductorFinal.Cofirmar_Carrera;
import ricardopazdemiquel.com.imotosconductorFinal.MainActivityConductor;
import ricardopazdemiquel.com.imotosconductorFinal.R;
import ricardopazdemiquel.com.imotosconductorFinal.utiles.Contexto;
import ricardopazdemiquel.com.imotosconductorFinal.utiles.Single;
    ...
    private void mensaje_recibido(RemoteMessage remoteMessage) {
        try {
            ...
            Notification notification= new NotificationCompat.Builder(this, Contexto.CHANNEL_ID)
                    .setContentTitle("iMotos: Nuevo mensaje")
                    .setContentText(obj.getString("mensaje"))
                    .setSmallIcon(R.mipmap.ic_imotosicon_foreground)
    ...
    private void confirmar_carrera(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            sendBroadcast(intent);
                ...
                notification5(10,R.mipmap.ic_imotosicon_foreground,"iMotos","Viaje Entrante",jsonUsuario,json);
